...
const createOrder = async(req, res)=>{
    ...
    const {userId, orderStatus, cartItems, cartId,
            addressInfo, paymentMethod, paymentStatus, 
            orderDate, orderUpdateDate, paymentId, 
            totalAmount, payerId} = req.body;
            ...
            paypal.payment.create(create_payment_json , async(error,paymentInfo)=>{
                if(error){
                    ...
                    const newCreatedOrder = new Order({
                       userId,cartId, orderStatus, cartItems, 
                       addressInfo, paymentMethod, paymentStatus, 
                       orderDate, orderUpdateDate, paymentId, 
                       totalAmount, payerId
                    })
